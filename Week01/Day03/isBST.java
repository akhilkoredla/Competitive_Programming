...
public class isBST {
    ...
    public static boolean isBinarySearchTree(BinaryTreeNode root,int low,int high){
        if(root==null)
            return true;
        ...
        return isBinarySearchTree(root.left,low,root.value) && isBinarySearchTree(root.right,root.value,high);
    }
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(isBST.class);
